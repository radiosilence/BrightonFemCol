...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('suave_press_category', (
        ...
        db.send_create_signal('suave_press', ['Category'])

        # Adding model 'Article'
        db.create_table('suave_press_article', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ...
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(related_name='articles', to=orm['auth.User'])),
        ))
        db.send_create_signal('suave_press', ['Article'])


    def backwards(self, orm):
        # Deleting model 'Category'
        db.delete_table('suave_press_category')

        # Deleting model 'Article'
        db.delete_table('suave_press_article')
