...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventImage.credit'
        db.add_column('suave_calendar_eventimage', 'credit',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventImage.credit'
        db.delete_column('suave_calendar_eventimage', 'credit')
