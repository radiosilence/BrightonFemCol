...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EventLink.information'
        db.alter_column('suave_calendar_eventlink', 'information', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'EventLink.information'
        db.alter_column('suave_calendar_eventlink', 'information', self.gf('django.db.models.fields.TextField')(null=True))
