...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('suave_calendar_category', 'identifier')

        # Deleting field 'Event.identifier'
        db.delete_column('suave_calendar_event', 'identifier')


    def backwards(self, orm):
        # Adding field 'Category.identifier'
        db.add_column('suave_calendar_category', 'identifier',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Event.identifier'
        db.add_column('suave_calendar_event', 'identifier',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)
